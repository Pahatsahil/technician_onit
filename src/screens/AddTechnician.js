...
import { AADHAR_BACK_IMAGE, AADHAR_FRONT_IMAGE, CREATE_NEW_TECHNICIAN, GET_ALL_SERVICES, TECHNICIAN_PAN_CARD, TECHNICIAN_PROFILE_PICTURE } from '../utils/endpoints';
...
export const AddTechnician = ({ navigation }) => {
    ...
    const uploadImageForPanCard = (uploadType, imageType) => {
        if (uploadType === 'camera') {
            ImagePicker.openCamera({
                ...
                setPanCard(panCard); setVisible(false)
            });
    ...
    const uploadImageForAadhaarFront = (uploadType, imageType) => {
        ...
        if (uploadType === 'camera') {
            ImagePicker.openCamera({
                ...
                setAadhaarCardFront(aadhaarCardFront); setAadhaarVisible(false)
            });
        } else if (uploadType === 'gallery') {
            ImagePicker.openPicker({
                height: 720,
    ...
    const uploadImageForAadhaarBack = (uploadType, imageType) => {
        if (uploadType === 'camera') {
            ImagePicker.openCamera({
                ...
                setAadhaarCardBack(aadhaarCardBack); setAadhaarBackVisible(false)
            });
        } else if (uploadType === 'gallery') {
            ImagePicker.openPicker({
                height: 720,
    ...
    const uploadImageForProfilePicture = (uploadType, imageType) => {
        if (uploadType === 'camera') {
            ImagePicker.openCamera({
                ...
                setProfilePicture(profilePicture); setVisible(false)
            });
        } else if (uploadType === "gallery") {
            ImagePicker.openPicker({
                height: 400,
    ...
    return (
        <>
            <Modal visible={visible} transparent={true} style={styles.modal_style} onRequestClose={() => setVisible(false)}>
                <View style={styles.modal_view}>
                    <View style={styles.modal_view2}>
                        ...
                        />
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForProfilePicture('camera', 'profilePicture')}>
            ...
            >
                ...
                >
                    <View
                        style={{ height: height / 2, width: width / 1.2, backgroundColor: "white", zIndex: 10 }}
                    >
                        <ScrollView >
                            {
                                allServices && allServices.map(item => (
                                    <TouchableOpacity
                                        onPress={() => { setSecondaryService(item); setServiceModal(false) }}
                                    >
                                        <Text style={{
                                            fontSize: 16,
                                            fontWeight: "bold",
            ...
            <Modal visible={aadhaarVisible} transparent={true} style={styles.modal_style} onRequestClose={() => setAadhaarVisible(false)}>
                <View style={styles.modal_view} >
                    <View style={styles.modal_view2}>
                        <Image
                            style={styles.upload_image}
                            source={require('../images/upload.png')}
                        />
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForAadhaarFront('camera', 'aadhaarCardFront')}>
                            <Text style={styles.modal_text}>Open Camera</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForAadhaarFront('gallery', 'panCard')}>
                            <Text style={styles.modal_text}>Select Image from gallery</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
            <Modal visible={aadhaarBackVisible} transparent={true} style={styles.modal_style} onRequestClose={() => setAadhaarBackVisible(false)}>
                <View style={styles.modal_view}>
                    <View style={styles.modal_view2}>
                        <Image
                            style={styles.upload_image}
                            source={require('../images/upload.png')}
                        />
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForAadhaarBack('camera', 'aadhaarCardBack')}>
                            <Text style={styles.modal_text}>Open Camera</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForAadhaarBack('gallery', 'aadhaarCardBack')}>
                            <Text style={styles.modal_text}>Select Image from gallery</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
            <Modal visible={panVisible} transparent={true} style={styles.modal_style} onRequestClose={() => setPanVisible(false)}>
                <View style={styles.modal_view}>
                    <View style={styles.modal_view2}>
                        <Image
                            style={styles.upload_image}
                            source={require('../images/upload.png')}
                        />
                        <TouchableOpacity style={styles.modal_button} onPress={() => { uploadImageForPanCard('camera', 'panCard'), setPanVisible(false) }}>
                            <Text style={styles.modal_text}>Open Camera</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.modal_button} onPress={() => { uploadImageForPanCard('gallery', 'panCard'), setPanVisible(false) }}>
                            <Text style={styles.modal_text}>Select Image from gallery</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ...
            <Modal visible={visible} transparent={true} style={styles.modal_style} onRequestClose={() => setVisible(false)}>
                <View style={styles.modal_view}>
                    <View style={styles.modal_view2}>
                        ...
                        <TouchableOpacity style={styles.modal_button} onPress={() => uploadImageForProfilePicture('gallery', 'profilePicture')}>
                            <Text style={styles.modal_text}>Select Image from gallery</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
                    ...
                    />
                    <View style={{ width: '90%', alignSelf: 'center', marginTop: StatusBar.currentHeight }}>
                        <Text
                            style={{
                                fontFamily: 'poppins-semibold',
                                color: '#000',
                        ...
                        <View style={{ justifyContent: "space-between", flexDirection: "row", }}>
                            ...
                            <TouchableOpacity style={styles.picture} onPress={() => setVisible(true)}>
                                {s3ProfileImage ? <Image
                        ...
                        <View style={styles.halfview}>
                            <View style={{ width: "48%" }}>
                                <Controller
                                    ...
                                    render={({ field: { onChange, onBlur, value } }) => (
                                        <TouchableOpacity
                                            style={[styles.halfinput, { alignItems: "center", justifyContent: "center" }]}
                        ...
                        <View>
                            ...
                            <View>
                                <Controller
                                    ...
                                    rules={{ required: true }}
                                />
                                {errors.address_line && <Text style={{ color: "red" }}>Address Line 1 is required!</Text>}
                            </View>
                            <View style={styles.halfview}>
                                <View style={{ width: "48%" }}>
                                    <Controller
                                ...
                                <View style={{ width: "48%" }}>
                                    <Controller
                                        ...
                                        defaultValue=""
                                        rules={{
                                            required: true, minLength: 6, maxLength: 6, pattern: {
                                                value: /^[1-9]{1}[0-9]{2}[0-9]{3}$/,
                                                message: 'Please enter a number',
                                            }
                                        }}
                                    />
                                    {errors.service_area_secondary_pincode?.type === "pattern" && <Text style={{ color: "red" }}>Enter valid PIN code.</Text>}
                                    {errors.service_area_secondary_pincode?.type === "required" && <Text style={{ color: "red" }}>Pincode is required.</Text>}
                                    {errors.service_area_secondary_pincode?.type === "minLength" && <Text style={{ color: "red" }}>Enter valid PIN code.</Text>}
                                    {errors.service_area_secondary_pincode?.type === "maxLength" && <Text style={{ color: "red" }}>Enter valid PIN code.</Text>}
                        ...
                        <View>
                            ...
                            <View>
                                ...
                                />
                                {errors.email?.type === "pattern" && <Text style={{ color: "red" }}>Enter a valid email</Text>}
                            </View>
                        </View>
                        ...
                        <View>
                            ...
                            <View style={styles.halfview}>
                                <View style={{ width: "48%" }}>
                                    ...
                                    />
                                    {errors.reference_person_name?.type === "required" && <Text style={{ color: "red", fontSize: 13 }}>Reference person is required!</Text>}
                                </View>
                                <View style={{ width: "48%" }}>
                                    <Controller
                                        control={control}
                                    ...
                                    />
                                    {errors.reference_person_mobile?.type === "required" && <Text style={{ color: "red", fontSize:13 }}>Mobile number is required!</Text>}
                                    {errors.reference_person_mobile?.type === "pattern" && <Text style={{ color: "red" }}>Enter a valid number</Text>}
                                </View>
                        ...
                        <View style={{ width: '100%', alignSelf: 'center' }}>
                            ...
                            <View>
                                ...
                                <Controller
                                    ...
                                    defaultValue=""
                                    rules={{
                                        required: true, minLength: 12, maxLength: 12, pattern: {
                                            value: /^[2-9]{1}[0-9]{3}[0-9]{4}[0-9]{4}$/,
                                            message: 'Please enter a number',
                                        }
                                    }}
                                />
                                {errors.aadhar_number?.type === "pattern" && <Text style={{ color: "red" }}>Aadhaar number should be numeric!</Text>}
                                {errors.aadhar_number?.type === "required" && <Text style={{ color: "red" }}>Aadhaar number is required!</Text>}
                                {errors.aadhar_number?.type === "minLength" && <Text style={{ color: "red" }}>Enter valid aadhaar number</Text>}
                                {errors.aadhar_number?.type === "maxLength" && <Text style={{ color: "red" }}>Enter valid aadhaar number</Text>}
                            </View>
                            <View
                                style={{
                                    flexDirection: 'row',
                                ...
                                <TouchableOpacity style={styles.uploadbox} onPress={() => setAadhaarVisible(true)}>

                                    {s3aadhaarCardFront ?
                                        <View style={{ flexGrow: 1, backgroundColor: 'green' }}>
                                            <TouchableOpacity style={{ height: 15, width: 15, borderRadius: 10, backgroundColor: 'red', position: 'absolute', top: -5, right: -5, zIndex: 10, }} onPress={() => sets3AadhaarCardFront()} >
                                                <Image
                                                    style={{ alignSelf: 'center', height: 15, width: 15, zIndex: 20 }}
                                                    source={cross}
                                                />
                                            </TouchableOpacity>
                                            <View >
                                                <Image
                                                    style={[styles.upload, { height: '100%', width: '100%', alignSelf: 'flex-end', left: 10 }]}
                                                    source={{
                                ...
                                <TouchableOpacity style={styles.uploadbox} onPress={() => setAadhaarBackVisible(true)}>
                                    {s3aadhaarCardBack ?
                                        <View style={{ flexGrow: 1, backgroundColor: 'green' }}>
                                            <TouchableOpacity style={{ height: 15, width: 15, borderRadius: 10, backgroundColor: 'red', position: 'absolute', top: -5, right: -5, zIndex: 10, }} onPress={() => sets3AadhaarCardBack()} >
                                                <Image
                                                    style={{ alignSelf: 'center', height: 15, width: 15, zIndex: 20 }}
                                                    source={cross}
                                                />
                            ...
                            <View>
                                ...
                                <Controller
                                    ...
                                    defaultValue=""
                                    rules={{
                                        required: true, minLength: 10, maxLength: 10, pattern: {
                                            value: /[A-Z]{5}[0-9]{4}[A-Z]{1}/,
                                            message: 'Please enter a number',
                                        }
                                    }}
                                />
                                {errors.pan?.type === "pattern" && <Text style={{ color: "red" }}>You are entering wrong PAN!</Text>}
                                {errors.pan?.type === "required" && <Text style={{ color: "red" }}>Pan number is required!</Text>}
                                {errors.pan?.type === "minLength" && <Text style={{ color: "red" }}>Enter valid Pan number</Text>}
                                {errors.pan?.type === "maxLength" && <Text style={{ color: "red" }}>Enter valid Pan number</Text>}
                            ...
                            <View>
                                ...
                                <TouchableOpacity style={styles.pan_upload} onPress={() => setPanVisible(true)} >
                                    {s3panCard ?
                                        <View style={{ flexGrow: 1, backgroundColor: 'green' }}>
                                            <TouchableOpacity style={{ height: 15, width: 15, borderRadius: 10, position: 'absolute', top: -5, right: -5, zIndex: 10, }} onPress={() => sets3PanCard()} >
                        ...
                        >
                            ...
                            <View style={{ width: '100%', backgroundColor: '#00796A', borderRadius: 4 }}>
