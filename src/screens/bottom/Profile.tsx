...
export default function Profile({ navigation: { navigate } }) {
    ...
    const captureAndShareScreenshot = () => {
        let shareImage = {
            message: `Greetings 🙏 Our services for ${userData?.userDetails?.services?.primary_services?.service_name.split(
                '-',
            )[0]
                } are Digital now !
     ...
     Center Name: ${userData.userDetails.personal_details.name
                }Contact Number: ${userData?.userDetails?.personal_details?.phone?.mobile_number
                }
       https://app.onit.services/#/booking/${userData.userDetails?.center_id[0].qr_details.qr_id
                }`,
                            ...
                            <View
                                ...
                                <View>
                                    <Image
                                        ...
                                        source={addtechnician}
                                        resizeMode="contain"
                                    />
                                </View>
                                <View style={{}}>
                                    <Text style={{ fontSize: 16, paddingLeft: 20, color: "black" }}>Technician</Text>
                            ...
                            <TouchableOpacity
                                ...
                                <View
                                    ...
                                    <View>
                                        <Image
                                            style={{ height: 30, width: 30 }}
                                            source={PROFILE_ITEMS.uri === 'Technicians'
                                                ? null
                                                : PROFILE_ITEMS.uri}
                                            resizeMode="contain"
                                        />
                                    ...
                                    <View style={{}}>
                                        ...
                                        {/* <Text>
                                            {
                                                !PROFILE_ITEMS.name === 'Technicians'
                                                    ? PROFILE_ITEMS.name
                                                    : null
                                            }
                                            {PROFILE_ITEMS.name}
