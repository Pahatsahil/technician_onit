...
const MainStack=()=>{
    ...
    return(
        <Stack.Navigator 
            initialRouteName={userData?.userDetails?.center_id[0]?.payment_details?.paid_for_onboarding_kit? 'Tab' : "Subscription"}
        >
            <Stack.Screen name="Tab" component={BottomTabs} options={{ headerShown: false }} />
            <Stack.Screen name="Subscription" component={Subscription} options={{ headerShown: false }} />
            <Stack.Screen name='Booking' component={Home} options={{ headerShown: false }} />
            ...
            <Stack.Screen name='AddTechnician' component={AddTechnician} options={{ headerShown: false }} />
            <Stack.Screen name='CreateTicket' component={CreateTicket} options={{headerShown: false}} />
            <Stack.Screen name='TechniciansList' component={TechniciansList} options={{ headerShown: false }} />
